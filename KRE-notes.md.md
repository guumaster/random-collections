 ...
 **Runtime**
Is an environment that is isolated from all other runtimes and other resources. Its where you can put one or more solutions. Th will share some resources. Here is where our price estimation solution is going to run. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAzMjQwMzA4NiwtMTAxMTg1MzQ0MSwtMj
